...
from numpy import _CharDType, _OrderKACF, _ShapeType, _SupportsBuffer, bytes_, dtype, int_, ndarray, object_, str_
from numpy._typing import NDArray, _ArrayLikeBool_co as b_co, _ArrayLikeBytes_co as S_co, _ArrayLikeInt_co as i_co, _ArrayLikeStr_co as U_co, _ShapeLike
...
class chararray(ndarray[_ShapeType, _CharDType]):
    ...
    @overload
    def __ge__(self: _CharArray[bytes_], other: S_co) -> NDArray[np.bool]:
        ...
    ...
    @overload
    def __le__(self: _CharArray[bytes_], other: S_co) -> NDArray[np.bool]:
        ...
    ...
    @overload
    def __gt__(self: _CharArray[bytes_], other: S_co) -> NDArray[np.bool]:
        ...
    ...
    @overload
    def __lt__(self: _CharArray[bytes_], other: S_co) -> NDArray[np.bool]:
        ...
    ...
    @overload
    def __add__(self: _CharArray[bytes_], other: S_co) -> _CharArray[bytes_]:
        ...
    ...
    @overload
    def __radd__(self: _CharArray[bytes_], other: S_co) -> _CharArray[bytes_]:
        ...
    ...
    @overload
    def center(self: _CharArray[bytes_], width: i_co, fillchar: S_co = ...) -> _CharArray[bytes_]:
        ...
    
    @overload
    def count(self: _CharArray[str_], sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def count(self: _CharArray[bytes_], sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    ...
    @overload
    def endswith(self: _CharArray[str_], suffix: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
        ...
    
    @overload
    def endswith(self: _CharArray[bytes_], suffix: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
        ...
    
    def expandtabs(self, tabsize: i_co = ...) -> chararray[Any, _CharDType]:
        ...
    
    @overload
    def find(self: _CharArray[str_], sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def find(self: _CharArray[bytes_], sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def index(self: _CharArray[str_], sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def index(self: _CharArray[bytes_], sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    ...
    @overload
    def ljust(self: _CharArray[bytes_], width: i_co, fillchar: S_co = ...) -> _CharArray[bytes_]:
        ...
    
    @overload
    def lstrip(self: _CharArray[str_], chars: None | U_co = ...) -> _CharArray[str_]:
        ...
    
    @overload
    def lstrip(self: _CharArray[bytes_], chars: None | S_co = ...) -> _CharArray[bytes_]:
        ...
    ...
    @overload
    def partition(self: _CharArray[bytes_], sep: S_co) -> _CharArray[bytes_]:
        ...
    
    @overload
    def replace(self: _CharArray[str_], old: U_co, new: U_co, count: None | i_co = ...) -> _CharArray[str_]:
        ...
    
    @overload
    def replace(self: _CharArray[bytes_], old: S_co, new: S_co, count: None | i_co = ...) -> _CharArray[bytes_]:
        ...
    
    @overload
    def rfind(self: _CharArray[str_], sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def rfind(self: _CharArray[bytes_], sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def rindex(self: _CharArray[str_], sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    
    @overload
    def rindex(self: _CharArray[bytes_], sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[int_]:
        ...
    ...
    @overload
    def rjust(self: _CharArray[bytes_], width: i_co, fillchar: S_co = ...) -> _CharArray[bytes_]:
        ...
    ...
    @overload
    def rsplit(self: _CharArray[str_], sep: None | U_co = ..., maxsplit: None | i_co = ...) -> NDArray[object_]:
        ...
    
    @overload
    def rsplit(self: _CharArray[bytes_], sep: None | S_co = ..., maxsplit: None | i_co = ...) -> NDArray[object_]:
        ...
    
    @overload
    def rstrip(self: _CharArray[str_], chars: None | U_co = ...) -> _CharArray[str_]:
        ...
    
    @overload
    def rstrip(self: _CharArray[bytes_], chars: None | S_co = ...) -> _CharArray[bytes_]:
        ...
    
    @overload
    def split(self: _CharArray[str_], sep: None | U_co = ..., maxsplit: None | i_co = ...) -> NDArray[object_]:
        ...
    
    @overload
    def split(self: _CharArray[bytes_], sep: None | S_co = ..., maxsplit: None | i_co = ...) -> NDArray[object_]:
        ...
    ...
    @overload
    def startswith(self: _CharArray[str_], prefix: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
        ...
    
    @overload
    def startswith(self: _CharArray[bytes_], prefix: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
        ...
    
    @overload
    def strip(self: _CharArray[str_], chars: None | U_co = ...) -> _CharArray[str_]:
        ...
    
    @overload
    def strip(self: _CharArray[bytes_], chars: None | S_co = ...) -> _CharArray[bytes_]:
        ...
    
    @overload
    def translate(self: _CharArray[str_], table: U_co, deletechars: None | U_co = ...) -> _CharArray[str_]:
        ...
    
    @overload
    def translate(self: _CharArray[bytes_], table: S_co, deletechars: None | S_co = ...) -> _CharArray[bytes_]:
        ...
...
@overload
def endswith(a: U_co, suffix: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
    ...

@overload
def endswith(a: S_co, suffix: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
    ...
...
@overload
def startswith(a: U_co, prefix: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
    ...

@overload
def startswith(a: S_co, prefix: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.bool]:
    ...
