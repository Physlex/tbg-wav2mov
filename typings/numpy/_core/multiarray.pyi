...
@overload
def empty_like(prototype: _ArrayType, dtype: None = ..., order: _OrderKACF = ..., subok: bool = ..., shape: None | _ShapeLike = ..., *, device: None | L["cpu"] = ...) -> _ArrayType:
    ...

@overload
def empty_like(prototype: _ArrayLike[_SCT], dtype: None = ..., order: _OrderKACF = ..., subok: bool = ..., shape: None | _ShapeLike = ..., *, device: None | L["cpu"] = ...) -> NDArray[_SCT]:
    ...

@overload
def empty_like(prototype: object, dtype: None = ..., order: _OrderKACF = ..., subok: bool = ..., shape: None | _ShapeLike = ..., *, device: None | L["cpu"] = ...) -> NDArray[Any]:
    ...

@overload
def empty_like(prototype: Any, dtype: _DTypeLike[_SCT], order: _OrderKACF = ..., subok: bool = ..., shape: None | _ShapeLike = ..., *, device: None | L["cpu"] = ...) -> NDArray[_SCT]:
    ...

@overload
def empty_like(prototype: Any, dtype: DTypeLike, order: _OrderKACF = ..., subok: bool = ..., shape: None | _ShapeLike = ..., *, device: None | L["cpu"] = ...) -> NDArray[Any]:
    ...

@overload
def array(object: _ArrayType, dtype: None = ..., *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: L[True], ndmin: int = ..., like: None | _SupportsArrayFunc = ...) -> _ArrayType:
    ...

@overload
def array(object: _ArrayLike[_SCT], dtype: None = ..., *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def array(object: object, dtype: None = ..., *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def array(object: Any, dtype: _DTypeLike[_SCT], *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def array(object: Any, dtype: DTypeLike, *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: None = ..., order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: _DTypeLike[_SCT], order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: DTypeLike, order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: None = ..., order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: _DTypeLike[_SCT], order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: DTypeLike, order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def asarray(a: _ArrayLike[_SCT], dtype: None = ..., order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asarray(a: object, dtype: None = ..., order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asarray(a: Any, dtype: _DTypeLike[_SCT], order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asarray(a: Any, dtype: DTypeLike, order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def arange(stop: _IntLike_co, /, *, dtype: None = ..., device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def arange(start: _IntLike_co, stop: _IntLike_co, step: _IntLike_co = ..., dtype: None = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def arange(stop: _FloatLike_co, /, *, dtype: None = ..., device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[floating[Any]]:
    ...

@overload
def arange(start: _FloatLike_co, stop: _FloatLike_co, step: _FloatLike_co = ..., dtype: None = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[floating[Any]]:
    ...

@overload
def arange(stop: _TD64Like_co, /, *, dtype: None = ..., device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[timedelta64]:
    ...

@overload
def arange(start: _TD64Like_co, stop: _TD64Like_co, step: _TD64Like_co = ..., dtype: None = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[timedelta64]:
    ...

@overload
def arange(start: datetime64, stop: datetime64, step: datetime64 = ..., dtype: None = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[datetime64]:
    ...

@overload
def arange(stop: Any, /, *, dtype: _DTypeLike[_SCT], device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def arange(start: Any, stop: Any, step: Any = ..., dtype: _DTypeLike[_SCT] = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def arange(stop: Any, /, *, dtype: DTypeLike, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def arange(start: Any, stop: Any, step: Any = ..., dtype: DTypeLike = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def is_busday(dates: _ScalarLike_co | dt.date, weekmask: ArrayLike = ..., holidays: None | ArrayLike | dt.date | _NestedSequence[dt.date] = ..., busdaycal: None | busdaycalendar = ..., out: None = ...) -> np.bool:
    ...

@overload
def is_busday(dates: ArrayLike | _NestedSequence[dt.date], weekmask: ArrayLike = ..., holidays: None | ArrayLike | dt.date | _NestedSequence[dt.date] = ..., busdaycal: None | busdaycalendar = ..., out: None = ...) -> NDArray[np.bool]:
    ...
...
@overload
def compare_chararrays(a1: _ArrayLikeStr_co, a2: _ArrayLikeStr_co, cmp: L["<", "<=", "==", ">=", ">", "!="], rstrip: bool) -> NDArray[np.bool]:
    ...

@overload
def compare_chararrays(a1: _ArrayLikeBytes_co, a2: _ArrayLikeBytes_co, cmp: L["<", "<=", "==", ">=", ">", "!="], rstrip: bool) -> NDArray[np.bool]:
    ...
