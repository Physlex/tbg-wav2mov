...
from numpy import _ByteOrder, _DType_co, _OrderKACF, _ShapeType, _SupportsBuffer, dtype, generic, ndarray, void
from numpy._typing import ArrayLike, DTypeLike, NDArray, _ArrayLikeInt_co, _ArrayLikeVoid_co, _NestedSequence, _ShapeLike
...
class recarray(ndarray[_ShapeType, _DType_co]):
    ...
    @overload
    def __new__(subtype, shape: _ShapeLike, dtype: DTypeLike, buf: None | _SupportsBuffer = ..., offset: SupportsIndex = ..., strides: None | _ShapeLike = ..., formats: None = ..., names: None = ..., titles: None = ..., byteorder: None = ..., aligned: Literal[False] = ..., order: _OrderKACF = ...) -> recarray[Any, dtype[Any]]:
        ...
