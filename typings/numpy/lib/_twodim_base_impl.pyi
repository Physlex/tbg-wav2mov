...
from numpy import _OrderCF, complexfloating, datetime64, float64, floating, generic, int_, intp, number, object_, signedinteger, timedelta64
...
_MaskFunc = Callable[[NDArray[int_], _T], NDArray[number[Any] | np.bool | timedelta64 | datetime64 | object_],]
__all__: list[str]
@overload
...
@overload
def eye(N: int, M: None | int = ..., k: int = ..., dtype: None = ..., order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def eye(N: int, M: None | int = ..., k: int = ..., dtype: _DTypeLike[_SCT] = ..., order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def eye(N: int, M: None | int = ..., k: int = ..., dtype: DTypeLike = ..., order: _OrderCF = ..., *, device: None | L["cpu"] = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
