...
from typing import Any, ClassVar, Final, Generator, Generic, Literal as L, NoReturn, Protocol, SupportsComplex, SupportsFloat, SupportsIndex, SupportsInt, TypeVar, final, overload
...
from numpy._core.numeric import allclose as allclose, argwhere as argwhere, array_equal as array_equal, array_equiv as array_equiv, astype as astype, base_repr as base_repr, binary_repr as binary_repr, convolve as convolve, correlate as correlate, count_nonzero as count_nonzero, cross as cross, flatnonzero as flatnonzero, fromfunction as fromfunction, full as full, full_like as full_like, identity as identity, indices as indices, isclose as isclose, isfortran as isfortran, isscalar as isscalar, moveaxis as moveaxis, ones as ones, ones_like as ones_like, outer as outer, roll as roll, rollaxis as rollaxis, tensordot as tensordot, vecdot as vecdot, zeros_like as zeros_like
from numpy._core.numerictypes import ScalarType as ScalarType, cast as cast, isdtype as isdtype, issubdtype as issubdtype, typecodes as typecodes
from numpy._core.shape_base import atleast_1d as atleast_1d, atleast_2d as atleast_2d, atleast_3d as atleast_3d, block as block, hstack as hstack, stack as stack, vstack as vstack
...
_ArrayLikeInt = (int | integer[Any] | Sequence[int | integer[Any]] | Sequence[Sequence[Any]] | NDArray[Any])
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    @overload
    def __array__(self, dtype: None = ..., /, *, copy: None | bool = ...) -> ndarray[Any, _DType_co]:
        ...
    
    @overload
    def __array__(self, dtype: _DType, /, *, copy: None | bool = ...) -> ndarray[Any, _DType]:
        ...
...
_ComplexValue = (None | _CharLike_co | SupportsFloat | SupportsComplex | SupportsIndex | complex)
...
class memmap(ndarray[_ShapeType, _DType_co]):
    ...
    def __array_wrap__(self, array: memmap[_ShapeType, _DType_co], context: None | tuple[ufunc, tuple[Any, ...], int] = ..., return_scalar: builtins.bool = ...) -> Any:
        ...
